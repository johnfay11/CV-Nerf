...
def parse_settings():
    ...
    parser.add_argument('--save_freq', type=int, default=1) #2500
    parser.add_argument('--video_freq', type=int, default=2) #5000
    parser.add_argument('--update_freq', type=int, default=1) #50
